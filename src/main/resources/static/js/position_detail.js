...
$(document).ready(function () {
    $.ajax({
        url: recruit_uri+"/user/favorOrNot/" + posId,
        type: "get",
        dataType: "json",
        success: function (msg) {
            if (msg == "0") {
...
$("#apply_tag").attr("href", recruit_uri+"/user/apply/" + posId);
$("#favor_tag").click(function () {
    if (favorFlag == 0) {
        $.ajax({
            url: recruit_uri+"/user/favor/" + posId,
            type: "get",
            dataType: "text",
            success: function (msg) {
                if (msg == "success") {
        ...
        $.ajax({
            url: recruit_uri+"/user/disfavor/" + posId,
            type: "get",
            dataType: "text",
            success: function (msg) {
                if (msg == "success") {
